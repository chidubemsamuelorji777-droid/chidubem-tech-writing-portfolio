...
### Chidubem Samuel Orji
TECHNICAL WRITER | CYBERSECURITY ENTHUSIAST | SOFTWARE TESTING STRATEGIST | SUPER FLEXIBLE  
Location: Remote | Email: chidubemsamuelorji777@gmail.com | [LinkedIn](www.linkedin.com/in/chidubem-orji)

#### About Me
Zealous and flexible Technical Writer/Editor with 5+ years of experience writing for different purposes and audiences.  
Expert when it comes to rhetorical sensitivity, style-guide adoption, clear communication, and exceeding delivery expectations.  
Passionate about accelerating software innovation through well-drafted technical documentation.  
Proven ability to;
- Test and master new software products speedily.
- Coordinate technical documentation for both technical and non-technical audiences.
- Align documentation process with SDLC.

#### Technical Toolkit
`Google docs` `Microsoft word` `Markdown` `Github` `Madcap Flare`

#### Achievements  
- Mastered technical writing tools and best practices within a month.
- Boosted expected personal content turnaround time by 100%, at Ariele Agency.
- Applied teaching methods that led to 100% student participation in classwork, as a Teaching Assistant.
...
**Google career certifications**: [Google cybersecurity specialization](https://www.coursera.org/account/accomplishments/specialization/KZII5NQ2XHG6), 2025
- Learnt cybersecurity best practices from Google's perspective.
- Hands-on experience using cybersecurity tools, Python, Linux, SQL, etc.

**Cisco networking academy**: [Introduction to cybersecurity](https://www.credly.com/badges/19229d4b-d628-402c-929b-8e3258caf523), 2024
- Introductory knowledge of cybersecurity, vulnerabilities, threat detection, and defense.
